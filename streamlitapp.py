...
MonthlyIncome_encoded = monthly_income_map[MonthlyIncome]

params = [JobSatisfaction, PerformanceRating, StandardHours,
          Joblevel, YearsAtCompany, WorkLifeBalance,
          YearsSinceLastPromotion, Department_encoded, MonthlyIncome_encoded]
...
if st.button('Predict'):
    try:
        ...
        output_ = requests.post(url='https://my-hr-fastapi-fastapi-app-url/predict', json=input_data)
