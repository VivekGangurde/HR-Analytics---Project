...
def main():
    ...
    def input_features() :
        ...
        age=st.number_input('Age of employee', 18,65,30,step = 1.)
        ...
        role = st.selectbox('Job Role', ['Research Director','Manager','Healthcare Representative','Manufacturing Director',
