...
def main():
    ...
    def input_features() :
        ...
        role = st.selectbox('Job Role', ['Research Director','Manager','Healthcare Representative','Manufacturing Director','Laboratory  
        Technician','Research Scientist','Sales Executive','Human Resources','Sales Representative'])
